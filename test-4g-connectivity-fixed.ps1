...
if ($sshTestCore.TcpTestSucceeded) {
    Write-Host "  [OK] SSH accessible sur Core VM" -ForegroundColor Green
    $testsPassedCount++
} else {
    Write-Host "  [FAIL] SSH non accessible sur Core VM" -ForegroundColor Red
}
...
if ($sshTestUE.TcpTestSucceeded) {
    Write-Host "  [OK] SSH accessible sur UE VM" -ForegroundColor Green
    $testsPassedCount++
} else {
    Write-Host "  [FAIL] SSH non accessible sur UE VM" -ForegroundColor Red
}
